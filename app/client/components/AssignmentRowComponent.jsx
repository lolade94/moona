...
const AssignmentRowComponent = ({dueDate, completionStatus, task, createdAt}) => {
  return (
    // Teddy: if you do decide to rename any of the names for data objects located in AssignmentTableComponent,
    // make sure they match with the object names located here
    <tr>
